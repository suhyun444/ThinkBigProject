...
public class MathpidConnector : MonoBehaviour
{
    [Header("My Info")]
    ...
    private IEnumerator Send_Diagnosis(int level)
    {
        ...
        // Debug.Log("print request Start");
        // Debug.Log(request.gameCd);
        // Debug.Log(request.mbrId);
        // Debug.Log(request.deviceNm);
        // Debug.Log(request.gameVer);
        // Debug.Log(request.osScnCd);
        // Debug.Log(request.timeZone);
        // Debug.Log("print request End");
